...
class RabbitMQClient:
    def __init__(self):
        ...
        if os.getenv("WMS_DEBUG", "true") == "true":
            print("[RABBITMQ] Running in debug mode. No real connections will be made.")
            # return
    ...
    def consume(self, queue, callback):
        if os.getenv("WMS_DEBUG", "ture") == "true":
            consume_mock(queue, callback)
        #     return
        # self.channel.queue_declare(queue=queue, durable=True)
        #
